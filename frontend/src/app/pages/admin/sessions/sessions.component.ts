              ...
              <div class="categories-section">
                ...
                <div class="cat-list">
                  @for (
                    ...
                    <div class="cat-row">
                      <button
                        class="cat-icon-btn"
                        (click)="toggleCatIconPicker(idx)"
                        [title]="cat.icon || 'Choose icon'">
                        <iconify-icon
                          [icon]="cat.icon || 'tabler:tag'"></iconify-icon>
                      </button>
                        ...
                        <div class="cat-icon-picker">
                          <div class="cat-icon-search">
                            ...
                            <input
                              ...
                              [value]="catIconSearch()"
                              (input)="
                                catIconSearch.set($any($event.target).value)
                              " />
                          </div>
                ...
                <div class="cat-add-row">
                  <input
                    ...
                    #catInput
                    (keydown.enter)="
                      addCategory(catInput); $event.preventDefault()
                    " />
                  <button
                    class="action-btn outline-btn cat-add-btn"
                    (click)="addCategory(catInput)">
...
export class SessionsComponent implements OnInit {
  ...
  saveSession(): void {
    ...
    const data = {
      ...
      categories: this.sessionCategories(),
    };
  ...
  readonly catAvailableIcons: { icon: string; label: string; tags: string }[] =
    [
      ...
      { icon: "tabler:coffee", label: "Coffee", tags: "coffee drink brew" },
      {
        icon: "tabler:fridge",
        label: "Fridge",
        tags: "fridge refrigerator kitchen",
      },
      {
        icon: "tabler:armchair",
        label: "Armchair",
        tags: "armchair sofa living room",
      },
